...
```diff
- Please be aware of this scammer on telegram: @bangyobsc and this group https://t.me/BSCTokensniperofficial.

- This is a scam and not in any way affiliated with this project, and may possibly have malicious code or steal your private key. 

- Please leave the group if you have joined and report him. The genuine telegram link is further down in the description. Thanks. 
```
